...
# # --- Sidebar with question history only ---
# with st.sidebar:
...
# if submit_button and user_input:
#     # Append full user message to chat history
#     st.session_state.chat_history.append({"role": "user", "content": user_input})
...
#     # Store only question heading/summary
#     heading = user_input.strip().split('\n')[0][:80]  # First 80 characters of the first line
